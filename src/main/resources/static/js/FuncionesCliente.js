...
function guardarInformacionClientes(){
    let var2 = {
        ...
        $.ajax({
            ...
            url:"http://144.22.57.76:8080/api/Client/save",
...
function borrarInformacionClientes (idElemnto){
    ...
    $.ajax({
        ...
        url:"http://144.22.57.76:8080/api/Client/"+idElemnto,
        success:function(response){
            console.log(response);
...
function editarInformacionCliente (idElemento){
    $.ajax({
        url:"http://144.22.57.76:8080/api/Client/"+idElemento,
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function InformacionCliente(){
    let var2 = {
        ...
        $.ajax({
            ...
            dataType: 'JSON',
            data: JSON.stringify(var2),
            url:"http://144.22.57.76:8080/api/Client/update",
