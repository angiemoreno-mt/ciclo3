function traerReporteStatus(){
    console.log("test");
    $.ajax({
        url:"http://144.22.57.76:8080/api/Reservation/report-status",
        type:"GET",
        datatype:"JSON",
...
function traerReporteDate(){
    ...
    console.log(fechaCierre);
        ...
        $.ajax({
            url:"http://144.22.57.76:8080/api/Reservation/report-dates/"+fechaInicio+"/"+fechaCierre,
            type:"GET",
            datatype:"JSON",
            success:function(respuesta){
                console.log(respuesta);
    ...
    function traerReporteClientes(){
        $.ajax({
            url:"http://144.22.57.76:8080/api/Reservation/report-clients",
            type:"GET",
            datatype:"JSON",
            success:function(respuesta){
                console.log(respuesta);
