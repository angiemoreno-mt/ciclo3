...
function guardarInformacionCategorias(){
    let var2 = {
        ...
        $.ajax({
            ...
            url:"http://144.22.57.76:8080/api/Category/save",
...
function borrarInformacionCategorias (idElemnto){
    ...
    $.ajax({
        ...
        url:"http://144.22.57.76:8080/api/Category/"+idElemnto,
        success:function(response){
            console.log(response);
...
function editarInformacionCategorias (idElemento){
    $.ajax({
        url:"http://144.22.57.76:8080/api/Category/"+idElemento,
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            $("#id").val(respuesta.id),
...
function InformacionCategorias(){
    let var2 = {
        ...
        $.ajax({
            ...
            dataType: 'JSON',
            data: JSON.stringify(var2),
            url:"http://144.22.57.76:8080/api/Category/update",
